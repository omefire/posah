!!! Find notes related to exception handling after the code section !!!
...
> -- Handle any unhandled application exception (i.e thrown by `raise` and not handled with local `rescue`)
...
>   InternalServerException ExceptionCode String -- Used when we don't know what specific application-exception to use
>   | UserAlreadyRegisteredException ExceptionCode String
>     deriving (Show, Eq, Generic)
> 
> instance FromJSON ServerException
> 
...
> -- ToDO: Implement a proper logger that will save errors to a file or something
